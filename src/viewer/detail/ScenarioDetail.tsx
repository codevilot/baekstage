...
export function ScenarioDetail({ graph, scenario, selected, screenshots = [], onSelect }: { graph: ScenarioGraph; scenario: ScenarioGraph; selected: ScenarioNode; screenshots?: ScenarioArtifact[]; onSelect: (id: string) => void }) {
