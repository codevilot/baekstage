...
export function ScenarioDetail({ graph, scenario, selected, screenshots = [], onSelect, onOpenStory }: { graph: ScenarioGraph; scenario: ScenarioGraph; selected: ScenarioNode; screenshots?: ScenarioArtifact[]; onSelect: (id: string) => void; onOpenStory?: (storyId: string) => void }) {
