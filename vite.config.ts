...
import openapi from "./src/examples/data-foundry-openapi.json";
import { dataFoundrySuite } from "./src/examples/data-foundry";
...
export default defineConfig({
  ...
  plugins: [react(), baekstagePlugin({
    ...
    catalog,
    suite: runtimeSuite,
    apiSources: [{ id: "dataset-manager", baseUrl: demoBaseUrl, environments: { Local: demoBaseUrl } }],
  })],
  server: {
    host: "127.0.0.1",
    port: 4173,
