...
- Refresh discovered scenario definitions automatically while the standalone CLI is running, keeping the viewer port stable and the last valid catalog available across invalid intermediate edits.
