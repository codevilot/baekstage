...
test("observes retry UI network evidence", async ({ page, baekstage }: any) => {
  ...
  await baekstage.step({ id: "click-retry", fromNodeId: "retry-button", toNodeId: "retry-request", edgeId: "retry-button-to-request", operationId: "openapi:dataset-manager:POST:/conversion/jobs/{id}/retry", caseId: "already-running", sourceId: "dataset-manager" }, async () => {
